...
df = data.frame(unlist(data1), unlist(data2), row.names = cols)
names(df) = c("Model 1", "Model 2")
df$diff = df$`Model 1` - df$`Model 2`
df
```
...
music$selgen <- ifelse(music$music_genre == gens[1], 1, 0)
