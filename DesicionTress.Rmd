...
cm = confusionMatrix(k10_new_genres, reference = testing[,"new_genres"] )
...
cm = confusionMatrix(k10_music_genre, reference = testing[,"music_genre"] )
...
cm = confusionMatrix(k10_new_genres_bal, reference = testing_bal[,"new_genres"] )
...
cm = confusionMatrix(k10_music_genre_bal, reference = testing_bal[,"music_genre"] )
