...
new_jazz<-rbind(jazz, not_jazz[1:5000,])
...
treefit_jazz<-rpart(new_genres_jazz ~ popularity + acousticness + danceability + energy + key +liveness + loudness + mode + speechiness + valence, data=training_jazz, method="class", control = list(maxdepth = 4))
...
new_hiphop<-rbind(hiphop, not_hiphop[1:5000,])
...
treefit_hiphop<-rpart(new_genres_hiphop ~ popularity + acousticness + danceability + energy + key +liveness + loudness + mode + speechiness + valence, data=training_hiphop, method="class", control = list(maxdepth = 4))
...
new_rap<-rbind(rap, not_rap[1:5000,])
...
treefit_rap<-rpart(new_genres_rap ~ popularity + acousticness + danceability + energy + key +liveness + loudness + mode + speechiness + valence, data=training_rap, method="class", control = list(maxdepth = 4))
